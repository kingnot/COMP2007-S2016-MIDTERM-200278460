...
namespace COMP2007_S2016_MidTerm_200278460
{
    public partial class TodoDetails : System.Web.UI.Page
    {
        ...
        /**
         * <summary>
         * This method gets the existing todo data from the DB
         * </summary>
         * 
         * @method GetTodo
         * @returns {void}
        ...
        protected void GetTodo()
        {
            ...
            using (TodoConnection db = new TodoConnection())
            {
                ...
                if (updatedTodo != null)
                {
                    ...
                    CompleteStateCheckBox.Checked = Convert.ToBoolean(updatedTodo.Completed);
                }
            }
        }
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            using (TodoConnection db = new TodoConnection())
            {
                ...
                newTodo.Completed = CompleteStateCheckBox.Checked;

                // use LINQ to ADO.NET to add / insert new todo item into the database
